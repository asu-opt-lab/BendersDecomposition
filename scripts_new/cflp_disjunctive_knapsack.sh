...
cp -r scripts_new/cflp_disjunctive_knapsack.jl "${OUTPUT_DIR}/cflp_disjunctive_knapsack.jl"
...
for instance in "${instances[@]}"; do
    ...
    echo "julia --project=. scripts_new/cflp_disjunctive_knapsack.jl --instance ${instance} --output_dir ${ERR_OUT_DIR}" >> "${JOBSCRIPT_FILE}"
