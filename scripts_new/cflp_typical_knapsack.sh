...
EXPERIMENT_VERSION="cflp_typical_knapsack_02"
EXPERIMENT_DESCRIPTION="benchmark inout0.01 lpmethod=2 privatenode"
...
cp -r scripts_new/cflp_typical_knapsack.jl "${OUTPUT_DIR}/cflp_typical_knapsack.jl"
