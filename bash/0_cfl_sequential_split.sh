...
echo "#SBATCH -p grp_gbyeon" >> willdelete/jobscript_hm_$1.sh
# echo "#SBATCH -q gbyeonqos" >> willdelete/jobscript_hm_$1.sh
echo "#SBATCH -N 1" >> willdelete/jobscript_hm_$1.sh
echo "#SBATCH -n 28" >> willdelete/jobscript_hm_$1.sh
...
echo "julia --project=. bash/0_cfl_sequential_split.jl --instance $1" >> willdelete/jobscript_hm_$1.sh
