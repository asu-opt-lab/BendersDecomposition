...
# echo "#SBATCH -p gbyeoncpu1" >> willdelete/jobscript_hm_$1.sh
...
echo "#SBATCH -t 0-02:00:00" >> willdelete/jobscript_hm_$1.sh
...
echo "julia --project=. bash/cfl_sequential_split.jl --instance $1 --cut_strategy $2 --SplitCGLPNormType $3 --SplitSetSelectionPolicy $4 --StrengthenCutStrategy $5 --SplitBendersStrategy $6" >> willdelete/jobscript_hm_$1.sh
