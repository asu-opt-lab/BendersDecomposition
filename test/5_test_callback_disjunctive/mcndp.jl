...
@testset verbose = true "CFLP Disjunctive Callback Benders Tests" begin
    problem = read_mcndp_instance("R", "", "r01.6.dow")
    ...
    @testset "Unified oracle" begin  
        ...
        model_reformulation!(lazy_oracle.model, 1.0; x=lazy_oracle.model[:x])
        ...
        for k=1:2
            ...
            model_reformulation!(typical_oracles[k].model, 1.0; x=typical_oracles[k].model[:x])
        end
