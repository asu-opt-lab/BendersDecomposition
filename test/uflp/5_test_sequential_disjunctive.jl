...
@testset "CFLP Disjunctive System Tests" begin
    ...
    for i in [1]
        @testset "Instance: p$(i)" begin
            ...
            disjunctive_system = DisjunctiveCut(ClassicalCut(), L1Norm(), PureDisjunctiveCut(), false, false, true,true)
            # disjunctive_system = DisjunctiveCut(FatKnapsackCut(), L1Norm(), PureDisjunctiveCut(), false, false, true,true)
