...
#                                     gap_tolerance = 1e-9, 
#                                     halt_limit = Int(1e9), 
#                                     # halt_limit = 15, # ad-hoc; need to work around tolerance issue for infeasibility cuts
#                                     iter_limit = Int(1e9),
#                                     verbose = true
#                             )
#             # solver parameters
...
@testset verbose = true "CFLP Specialized Sequential Benders Tests" begin
    # instances = setdiff(1:71, [67])
    instances = [29]
    # (fail: 29, 30, 35) -> 29, 30, 31
    # (success: 25, 31-32, 34, 36, 49, 51) -> classical/knapsack: 25, 32, 34, 35, 36, 49, 51
