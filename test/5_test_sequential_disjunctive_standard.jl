        ...
        @testset "Instance: p$i" begin
            ...
            @testset "Classical oracle" begin
                @testset "Seq" begin        
                    ...
                    for strengthened in [false], add_benders_cuts_to_master in [false], reuse_dcglp in [true], p in [Inf], disjunctive_cut_append_rule in [NoDisjunctiveCuts()]
                        @info "solving UFLP p$i - disjunctive oracle/classical - strgthnd $strengthened; benders2master $add_benders_cuts_to_master reuse $reuse_dcglp dcut_append $disjunctive_cut_append_rule"
                        @testset "strgthnd $strengthened; benders2master $add_benders_cuts_to_master reuse $reuse_dcglp dcut_append $disjunctive_cut_append_rule" begin
                            ...
                            oracle_param = DisjunctiveOracleParam(norm = StandardNorm(), 
