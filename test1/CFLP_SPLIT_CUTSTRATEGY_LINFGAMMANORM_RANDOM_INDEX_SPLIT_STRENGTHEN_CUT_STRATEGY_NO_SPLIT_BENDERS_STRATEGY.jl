...
CSV.write("results/Gurobi/result_$(instance)_SPLIT_CUTSTRATEGY_LINFGAMMANORM_RANDOM_INDEX_SPLIT_STRENGTHEN_CUT_STRATEGY_NO_SPLIT_BENDERS_STRATEGY.csv", df)
