...
algo_params = SplitBenders.AlgorithmParams(
    ...
    SplitCGLPNormType=Main.SplitBenders.L1GammaNorm(), 
...
CSV.write("results/Gurobi/result_$(instance)_SPLIT_CUTSTRATEGY_L1GAMMANORM_MOST_FRAC_INDEX_SPLIT_STRENGTHEN_CUT_STRATEGY_TIGHT_SPLIT_BENDERS_STRATEGY.csv", df)
