...
ROUND_VERSION="simplex_norm_dcglp/cflp_classical"
...
EXPERIMENT_DESCRIPTION="${HOUR} hr, seed = ${SEED}, polar classical"
...
for instance in "${instances[@]}"; do
    ...
    echo "julia --project=polardcglp polardcglp/scripts/simplex_norm_dcglp/${FILE_NAME} --instance=${instance} --seed=${SEED} --time_limit=${TIME_LIMIT} --root_time_limit=${ROOT_TIME_LIMIT} --dcglp_time_limit=${DCGLP_TIME_LIMIT} --output_dir=${OUTPUT_DIR}" >> "${JOBSCRIPT_FILE}"
