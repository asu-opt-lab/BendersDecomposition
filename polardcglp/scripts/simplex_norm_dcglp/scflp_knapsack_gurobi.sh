...
ROUND_VERSION="simplex_norm_dcglp/scflp_knapsack_gurobi"
ROUND_DESCRIPTION="SimplexNormDCGLP SCFLP, knapsack typical oracle, 7 private cores, Gurobi"
...
for instance in "${instances[@]}"; do
    ...
    echo "julia --project=polardcglp polardcglp/scripts/simplex_norm_dcglp/${FILE_NAME} --instance=${instance} --seed=${SEED}" >> "${JOBSCRIPT_FILE}"
