...
ROUND_VERSION="vertical_reverse_polar/cflp_knapsack_gurobi"
ROUND_DESCRIPTION="vertical_reverse_polar hard CFL, knapsack, 7 private cores, Gurobi"
...
FILE_NAME="cflp_knapsack_gurobi.jl"
SHELL_FILE_NAME="cflp_knapsack_gurobi.sh"
THREADS=7
