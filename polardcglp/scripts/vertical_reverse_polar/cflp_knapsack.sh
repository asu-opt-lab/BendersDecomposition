...
ROUND_VERSION="vertical_reverse_polar/cflp_knapsack"
ROUND_DESCRIPTION="vertical_reverse_polar hard CFL, knapsack, 7 private cores, CPLEX"
...
FILE_NAME="cflp_knapsack.jl"
SHELL_FILE_NAME="cflp_knapsack.sh"
THREADS=7
