...
ROUND_VERSION="vertical_reverse_polar/snip_classical_gurobi"
ROUND_DESCRIPTION="vertical_reverse_polar SNIP, classical separable oracle, freq500, 56 cores SLURM, julia --threads=8, Gurobi"
...
SHELL_FILE_NAME="snip_classical_gurobi.sh"
THREADS=56
JULIA_THREADS=8
