...
ROUND_VERSION="vertical_reverse_polar/uflp_knapsack_gurobi"
ROUND_DESCRIPTION="vertical_reverse_polar hard UFL, freq500, knapsack, 7 private cores, Gurobi"
EXPERIMENT_VERSION="500_nobenders"
SEED="1"
HOUR="04"
TIME_LIMIT="14400"
...
STRENGTHENED="true"
LIFT="false"
EXPERIMENT_DESCRIPTION="${HOUR} hr, seed = ${SEED}, vertical_reverse_polar (Gurobi)"

FILE_NAME="uflp_knapsack_gurobi.jl"
SHELL_FILE_NAME="uflp_knapsack_gurobi.sh"
THREADS=7
