...
@testset verbose = true "UFLP Sequential Simplex Norm Test Tests -- MIP master" begin
    ...
    for i in instances
        @testset "Instance: p$i" begin
            ...
            @testset "Classical oracle" begin
                @testset "Seq" begin
                    @info "solving SimplexNormTestDCGLP UFLP p$i - classical - seq"
            ...
            @testset "Fat knapsack oracle" begin
                @testset "Seq" begin
                    @info "solving SimplexNormTestDCGLP UFLP p$i - fat knapsack - seq"
