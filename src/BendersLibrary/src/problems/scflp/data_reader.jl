...
_scflp_data_path() = get_artifact_path("scflp", "SCFLP", @__DIR__)
...
function read_stochastic_capacited_facility_location_problem(filename::String; filepath=_scflp_data_path())
