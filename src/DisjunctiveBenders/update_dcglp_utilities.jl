function get_subproblem_value(sub::AbstractSubProblem, x_value::Vector{Float64}, cut_strategy::AbstractCutStrategy)
...
function select_disjunctive_inequality(x_value)
    ...
    a[index] = 1
    @info "Selected disjunction index: $index, value_x: $(x_value[index])"
    return a, 0
end
