            ...
            state.master_time = @elapsed begin
                ...
                try 
                    ...
                    if throw_typical_cuts_for_errors
                        ...
                        typical_oracles[1] == DualDecomposition && println("t:$t_value, f_dual:$(typical_oracles[1].oracle_log.fin_LB_set[end]), f_opt:$(f_x)")
            ...
            for i in 1:2
                ...
                state.oracle_times[i] = @elapsed begin
                    if ω_0[i] >= oracle.oracle_param.zero_tol
                        ...
                        typeof(typical_oracles[i]) == DualDecomposition && println("t:$(ω_t[i] / ω_0[i]),f_dual:$(typical_oracles[i].oracle_log.fin_LB_set[end]), f_opt:$(state.f_x[i])")
