...
ROUND_DESCRIPTION="DD_disjunctive"
EXPERIMENT_VERSION="1010_DD_disjunctive"
EXPERIMENT_DESCRIPTION="strict_params, all output instances"
...
cp -r scripts/cflp_disjunctive_DD.jl "${OUTPUT_DIR}/cflp_disjunctive_DD.jl"
...
for instance in "${instances[@]}"; do
    ...
    echo "JULIA_NUM_THREADS=7 julia --project=. scripts/cflp_typical_DD.jl --instance ${instance} --output_dir ${OUTPUT_DIR}" >> "${JOBSCRIPT_FILE}"
