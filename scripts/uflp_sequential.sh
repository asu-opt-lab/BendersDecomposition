...
config_path="scripts/config/config_uflp_disjunctive_sequential.toml"
# config_path="scripts/config/config_uflp_knapsack_basic.toml"

JOBSCRIPT_DIR="scripts"
OUTPUT_DIR="specialized_benders_TTT_L1_violatedcuts_includeJ"
...
for instance in "${instances[@]}"; do
    ...
    echo "julia --project=. scripts/uflp_sequential.jl --instance ${instance} --output_dir ${OUTPUT_DIR} --config ${OUTPUT_DIR}/config.toml" >> "${JOBSCRIPT_FILE}"
