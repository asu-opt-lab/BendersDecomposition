...
OUTPUT_DIR="experiments_final_14/cflp_milp_test"
...
for instance in "${instances[@]}"; do
    ...
    echo "julia --project=. scripts/milp_cflp.jl --instance ${instance} --output_dir ${OUTPUT_DIR} --config ${config_path}" >> "${JOBSCRIPT_FILE}"
