...
ROUND_DESCRIPTION="disjunctive_knapsack_w_strict_params"
EXPERIMENT_VERSION="1002_disjunctive_knapsack_strict"
EXPERIMENT_DESCRIPTION="① strict_param, ② dcglp_iterlimit" ******* too many iterations when solving dcglp need to change it!!!
...
for instance in "${instances[@]}"; do
    ...
    echo "julia --project=. scripts/cflp_disjunctive_knapsack.jl --instance ${instance} --output_dir ${OUTPUT_DIR}" >> "${JOBSCRIPT_FILE}"
