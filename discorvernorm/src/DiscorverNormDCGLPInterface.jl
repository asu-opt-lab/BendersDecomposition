function install_disjunctive_cuts!(oracle::DiscorverNormDCGLPOracle, cuts::Vector{BendersX.Hyperplane})
    dcglp = oracle.dcglp
...
function append_current_disjunctive_cut!(oracle::DiscorverNormDCGLPOracle, cut::BendersX.Hyperplane)
...
function add_disjunctive_cuts!(oracle::DiscorverNormDCGLPOracle, ::BendersX.NoDisjunctiveCuts)
    return nothing
end

function add_disjunctive_cuts!(oracle::DiscorverNormDCGLPOracle, ::BendersX.AllDisjunctiveCuts)
    return nothing
end

function add_disjunctive_cuts!(oracle::DiscorverNormDCGLPOracle, ::BendersX.DisjunctiveCutsSmallerIndices)
...
function BendersX.generate_cuts(
    ...
    support_diffs_x, support_diffs_t = replace_support_constraints!(oracle, x_value, t_value)
    ...
    return optimize_discorvernorm_dcglp!(
        oracle,
        x_value,
        t_value,
        support_diffs_x,
