...
@testset verbose = true "CFLP FLCAP Sequential InOut Typical Tests" begin
    ...
    for instance_name in instances
        @testset "Instance: $instance_name" begin
            ...
            @testset "Classical oracle" begin
                @info "solving typical CFLP FLCAP $instance_name - classical - seqinout"
            ...
            @testset "Knapsack oracle" begin
                @info "solving typical CFLP FLCAP $instance_name - knapsack - seqinout"
                master = Master(data; customize = customize_master_model!, optimizer = mip_optimizer)
