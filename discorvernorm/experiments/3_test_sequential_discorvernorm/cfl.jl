...
@testset verbose = true "CFLP Sequential DiscorverNorm Tests" begin
    ...
    for i in instances
        @testset "Instance: p$i" begin
            ...
            @testset "Classical oracle" begin
                @testset "Seq" begin
                    @info "solving DiscorverNormDCGLP CFLP p$i - classical - seq"
                ...
                @testset "SeqInOut" begin
                    @info "solving DiscorverNormDCGLP CFLP p$i - classical - seqinout"
            ...
            @testset "Knapsack oracle" begin
                @testset "Seq" begin
                    @info "solving DiscorverNormDCGLP CFLP p$i - knapsack - seq"
                ...
                @testset "SeqInOut" begin
                    @info "solving DiscorverNormDCGLP CFLP p$i - knapsack - seqinout"
