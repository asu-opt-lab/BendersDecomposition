...
function customize_master_model!(model::Model, data::UFLPData)
    optimizer = optimizer_with_attributes(Gurobi.Optimizer,
        "Threads" => threads, "IntFeasTol" => 1e-9,
...
dcglp_optimizer = optimizer_with_attributes(Gurobi.Optimizer,
    "FeasibilityTol" => 1e-9, "NumericFocus" => 1,
    "OptimalityTol" => 1e-9, "Threads" => threads,
    MOI.Silent() => true)
