...
ROUND_VERSION="cflp_typical_knapsack"
ROUND_DESCRIPTION="CFLP Benders BnB, typical knapsack oracle, 7 private cores"
...
FILE_NAME="cflp_typical_knapsack.jl"
THREADS=7
...
for instance in "${instances[@]}"; do
    ...
    echo "julia --project=experiments/scripts experiments/scripts/${FILE_NAME} --instance ${instance} --output_dir ${OUTPUT_DIR} --seed ${SEED} --time_limit ${TIME_LIMIT}" >> "${JOBSCRIPT_FILE}"
