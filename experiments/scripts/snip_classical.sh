...
ROUND_VERSION="snip_classical"
ROUND_DESCRIPTION="snip classical BendersBnB + LazyCallback + BendersSeqInOut root, 56 cores SLURM, julia --threads=8"
...
for instance_no in "${instance_nos[@]}"; do
    for snip_no in "${snip_nos[@]}"; do
        for budget in "${budgets[@]}"; do
            ...
            echo "#SBATCH --nodelist=pcc036pcc037" >> "${JOBSCRIPT_FILE}"
