...
ROUND_VERSION="uflp_bnb_knapsack_gurobi"
ROUND_DESCRIPTION="7 private cores, Gurobi"
EXPERIMENT_VERSION="2_master_single_core"
SEED="1"
HOUR="04"
EXPERIMENT_DESCRIPTION="${HOUR} hr, seed = ${SEED}"

FILE_NAME="uflp_bnb_knapsack_gurobi.jl"
THREADS=7
